...
oosError
```
The accuracy of the model is 99.37% and the out-of-sample error based on the cross validation dataset is 0.63%. The accuracy and the out of sample error is healthy. Hence, this model can be applied to real test set.
